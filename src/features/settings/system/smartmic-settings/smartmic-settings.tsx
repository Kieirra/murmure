...
import { useSmartmicState } from './hooks/use-smartmic-state';
    ...
    return (
        <>
            <SettingsUI.Item>
                ...
                <Switch checked={smartmicEnabled} onCheckedChange={setSmartmicEnabled} />
            </SettingsUI.Item>
            {smartmicEnabled && (
                <>
                    ...
                    <SettingsUI.Item>
                        <SettingsUI.Description>
                            <Typography.Title>{t('SmartMic Port')}</Typography.Title>
                            <Typography.Paragraph>
                                {t('Set the port number for the SmartMic HTTPS server (1024-65535)')}
                            </Typography.Paragraph>
                        </SettingsUI.Description>
                        <NumberInput
                            min={1024}
                        ...
                        <>
                            ...
                            <SettingsUI.Item>
                                <SettingsUI.Description>
                                    ...
                                    <Typography.Paragraph>
                                        {t('Devices that have been paired with SmartMic')}
                                    </Typography.Paragraph>
