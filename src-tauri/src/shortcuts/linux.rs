...
use crate::shortcuts::{initialize_shortcut_states, keys_to_string, IsToggleRequiredForRecording, LLMRecordShortcutKeys, LastTranscriptShortcutKeys, RecordShortcutKeys, TranscriptionSuspended};
        ...
        loop {
            ...
            if all_record_keys_down || all_llm_record_keys_down {
                if is_toggle_required_for_recording {
                    ...
                    dbg!("Is recording toggled", is_recording_toggled);
